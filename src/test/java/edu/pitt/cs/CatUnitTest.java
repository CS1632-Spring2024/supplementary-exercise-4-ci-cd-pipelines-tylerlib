...
public class CatUnitTest {
	...
	public void setUp() throws Exception {
		...
		// Creating a mocked Cat with ID 1 and name "Jennyanydots"
	...
	public void testGetId() {
		int testID = c.getId();
		assertEquals(1, testID); //Test will pass if return value is 1
	}
	...
	public void testToString() {
		String testToString = c.toString();
		assertEquals("ID 1. Jennyanydots", testToString);
	}
	...
	public void testReturnCat() {
		c.returnCat();
		boolean rentedReturn = c.getRented();
		assertFalse(rentedReturn);
	}
